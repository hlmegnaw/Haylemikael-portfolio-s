...
export const Contact = ({ data }) => {
  ...
  const handleSubmit = (e) => {
    ...
    // Construct mailto link with pre-filled inputs
  ...
  return (
    <section id="contact" className="py-20 bg-white dark:bg-navy-950/40 border-t border-slate-200/80 dark:border-slate-800/80">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div className="p-6 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xs space-y-3">
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-white dark:bg-slate-850 border border-slate-200/80 dark:border-slate-750">
                <div className="flex items-center gap-3">
                  <div className="p-2 rounded bg-blue-50 dark:bg-blue-950 text-blue-600 dark:text-blue-400">
                    <Linkedin className="w-4 h-4" />
                  </div>
                  <div>
                    <span className="text-xs font-semibold text-slate-900 dark:text-white block">LinkedIn</span>
                    <span className="text-[11px] font-mono text-slate-500">Haylemikael Gurba Goshe</span>
                  </div>
                </div>
                {isLinkedinValid ? (
                  <a
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-white dark:bg-slate-850 border border-slate-200/80 dark:border-slate-750">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-xs font-semibold text-slate-900 dark:text-white block">GitHub</span>
              ...
              <div className="flex items-center gap-3 p-3 rounded-lg bg-white dark:bg-slate-850 border border-slate-200/80 dark:border-slate-750">
                ...
                <div>
                  <span className="text-xs font-semibold text-slate-900 dark:text-white block">Current Location</span>
                  <span className="text-xs text-slate-600 dark:text-slate-400">{contact.location}</span>
                </div>
              </div>
            </div>
          ...
          {/* Academic / Inquiry Contact Form (7 cols) */}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="MSc in Computer Science / AI Program Inquiry"
                    className="w-full px-3.5 py-2.5 text-sm rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
                  />
                </div>
